...
from poroelastic import PoroelasticWaveSolver
from poroelastic import RickerSource, Receiver, TimeAxis, demo_model, plot_image
# ==============================================================================
...
def poroelastic_setup(shape=(50, 50), spacing=(15.0, 15.0), tn=0.5, space_order=4, nbpml=10,
    ...
    src = RickerSource(name='src', grid=model.grid, f0=50.0, time_range=time_range)
...
if __name__ == "__main__":
    ...
    if args.dim2:
        shape = (1500, 1500)   # Dimensions, m
        spacing = (3.0, 3.0) # Spacing, m
        tn = 0.06
